...
# muchos valores en azure tienen que ser unicos une el namespace con un numero aleatorio y lo limita a 24 caracteres de largo
locals {
  namespace = substr(join("-", [var.namespace, random_string.rand.result]), 0, 24)
}

# Todo en azure funciona con grupos de recursos
